...
P3_MODEL_FP='354daf36f94207a6ff2aa0b9c91b1849c8fe47758fad07cb819bc57edd823117'
...
def prepare_model():
 ...
 ck=OUT/'m80-l2-self-v2.pt'; torch.save(state,ck); model_fp=torch_model_fingerprint(model,spec).hex(); row.update({'checkpoint_bytes':ck.stat().st_size,'checkpoint_archive_sha256':sha(ck.read_bytes()),'canonical_model_fingerprint':model_fp,'matches_pilot003_model_fingerprint':model_fp==P3_MODEL_FP})
